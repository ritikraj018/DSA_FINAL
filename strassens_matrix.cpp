...
vector<vector<int>> multiply_matrix(vector<vector<int>> matrix_A, vector<vector<int>> matrix_B)
{
    ...
    else
    {
        ...
        add_matrix(multiply_matrix(a00, b00), multiply_matrix(a01, b10),
                   result_matrix_00, split_index);
        add_matrix(multiply_matrix(a00, b01), multiply_matrix(a01, b11),
                   result_matrix_01, split_index);
        add_matrix(multiply_matrix(a10, b00), multiply_matrix(a11, b10),
                   result_matrix_10, split_index);
        add_matrix(multiply_matrix(a10, b01), multiply_matrix(a11, b11),
...
void print(vector<vector<int>> mat, int srow, int scolumn, int erow, int ecolumn)
{
...
int main()
{
    vector<vector<int>> matrix_A = {{5, 4, 1, 3},
                                    {6, 1, 2, 6},
                                    {2, 9, 7, 4},
                                    {4, 8, 3, 6}};
    ...
    vector<vector<int>> matrix_B = {{4, 5, 8, 4},
                                    {3, 0, 1, 0},
                                    {0, 7, 7, 9},
                                    {4, 5, 7, 0}};
